...
for i in range(0, len(frequencies)):
    ...
    slurm_class.boundaries = {"k0": [1e-3, 500], 
                        ...
                        "cap_phase_phase":[0.8*results_dict["PSV"][frequencies[i]]["cap_phase_phase"], 1.2*results_dict["PSV"][frequencies[i]]["cap_phase_phase"]],
                        "cap_phase_delta_E":[0.8*results_dict["PSV"][frequencies[i]]["cap_phase_delta_E"], 1.2*results_dict["PSV"][frequencies[i]]["cap_phase_delta_E"]],
                        "cap_phase_omega":[0.8*results_dict["PSV"][frequencies[i]]["cap_phase_omega"], 1.2*results_dict["PSV"][frequencies[i]]["cap_phase_omega"]],
    ...
    slurm_class.optim_list = ["E0_mean","E0_std","k0","gamma", "Ru","Cdl","CdlE1","CdlE2","CdlE3","omega","phase", "cap_phase","cap_phase_phase","cap_phase_delta_E","cap_phase_omega"]
    slurm_class.setup(
        datafile="",
        cpu_ram="8G",
        time="0-00:10:00",
        ...
        check_experiments={"FTACV":{"file":"", "parameters":results_dict["FTACV"]["250"][]}},
